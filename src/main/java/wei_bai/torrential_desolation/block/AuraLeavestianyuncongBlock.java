...
public class AuraLeavestianyuncongBlock extends TorrentialDesolationModElements.ModElement {
	@ObjectHolder("torrential_desolation:aura_leavestianyuncong")
	public static final Block block = null;

	public AuraLeavestianyuncongBlock(TorrentialDesolationModElements instance) {
		super(instance, 63);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("aura_leavestianyuncong");
		}
