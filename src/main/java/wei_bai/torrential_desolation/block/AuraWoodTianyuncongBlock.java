...
public class AuraWoodTianyuncongBlock extends TorrentialDesolationModElements.ModElement {
	@ObjectHolder("torrential_desolation:aura_log_tianyuncong")
	public static final Block block = null;

	public AuraWoodTianyuncongBlock(TorrentialDesolationModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("aura_log_tianyuncong");
		}
