...
public class ContainsAuraStoneBlock extends TorrentialDesolationModElements.ModElement {
	@ObjectHolder("torrential_desolation:contains_aura_stone")
	public static final Block block = null;

	public ContainsAuraStoneBlock(TorrentialDesolationModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("contains_aura_stone");
		}
