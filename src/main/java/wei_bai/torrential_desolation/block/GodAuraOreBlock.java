...
public class GodAuraOreBlock extends TorrentialDesolationModElements.ModElement {
	@ObjectHolder("torrential_desolation:god_aura_ore")
	public static final Block block = null;

	public GodAuraOreBlock(TorrentialDesolationModElements instance) {
		super(instance, 49);
	}
